...
namespace Synergi_nflint
{
    public class Program
    {
        ...
        static async Task Main(string[] args)
        {
            ...
            Logging.OutputLog("Information", "Scanning for tweets containing " + SearchTerm);
            ...
            Console.WriteLine("{0} Tweets containing {1} have been archived",TweetCount, SearchTerm);
            Thread.Sleep(2000);
        }
